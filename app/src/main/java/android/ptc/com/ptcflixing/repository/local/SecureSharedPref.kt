...
object SecureSharedPref : SharedPreferences {
    ...
    private val keyChain: KeyChain? =
        SharedPrefsBackedKeyChain(JumiaApplication.getContext(), CryptoConfig.KEY_256)
    private val sharedPrefFilename: String? = "secureShared"
    private val entity: Entity? = Entity.create(sharedPrefFilename)
    private val sharedPreferences: SharedPreferences?
        get() =
            JumiaApplication.getContext()
    ...
    init {
        SoLoader.init(JumiaApplication.getContext(), false)
    }
